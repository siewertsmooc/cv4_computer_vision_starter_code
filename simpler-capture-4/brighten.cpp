...
double alpha=1.0;  int beta2=10;  /* contrast and brightness control */
...
int main( int argc, char** argv )
{
    ...
    std::cout<<"* Enter beta2 contrast increase value [0-100]: "; std::cin>>beta2;

    // Do the operation new_image(i,j) = alpha*image(i,j) + beta2
        ...
        { 
            for( int c = 0; c < 3; c++ )
                new_image.at<Vec3b>(y,x)[c] =
                    saturate_cast<uchar>( alpha*( image.at<Vec3b>(y,x)[c] ) + beta2 );
        }
    }
